> Archived upstream project introduction, retained for reference. Upstream training results, screenshots and claims below are not personal results of this practice project. Start with [README.md](README.md) for this repository's scope and [UPSTREAM.md](UPSTREAM.md) for attribution.
